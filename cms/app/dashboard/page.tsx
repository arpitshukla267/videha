    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-6 md:p-8 rounded-2xl border border-slate-200/70 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-1">
          ...
          <p className="text-sm text-slate-500 max-w-xl">
            Control your website content, product catalogue, hero slides, and business details from your unified dashboard.
          </p>
        </div>
      ...
      >
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-sm">Backend API Server Status:</span>
              {health === null ? (
      ...
      <Card>
        <CardHeader className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-bold text-slate-900 text-base">Quick Access Modules</h2>
          </div>
          <span className="text-xs text-slate-400 font-medium">Click to navigate directly</span>
        </CardHeader>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {overviewSections.map((sec) => (
          <Card key={sec.title} className="hover:border-purple-300 transition-all duration-200">
