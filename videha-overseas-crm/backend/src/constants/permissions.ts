export const PERMISSIONS = [
  ...
  },
  {
    ...
    name: "View Shipments",
    category: "orders",
    description: "View export shipment records",
  },
  {
    code: "shipments.create",
    name: "Create Shipments",
    category: "orders",
    description: "Create export shipment records",
  },
  {
    code: "shipments.edit",
    name: "Edit Shipments",
    category: "orders",
    description: "Edit export shipment records",
  },
  {
    code: "documents.view",
    name: "View Documents",
    category: "documents",
    description: "View CRM file library and linked entity documents",
  },
  {
    code: "documents.create",
    name: "Upload Documents",
    category: "documents",
    description: "Upload files to Cloudinary and link them to CRM records",
  },
  {
    code: "documents.edit",
    name: "Edit Documents",
    category: "documents",
    description: "Rename document titles",
  },
  {
    code: "documents.delete",
    name: "Delete Documents",
    category: "documents",
    description: "Delete documents from CRM and Cloudinary",
  },
  ...
  },
  {
    ...
    name: "View Suppliers",
    category: "finance",
    description: "View supplier directory and procurement contacts",
  },
  {
  ...
  },
  {
    ...
    name: "Edit Suppliers",
    category: "finance",
    description: "Edit supplier records and import supplier CSV data",
  },
  {
